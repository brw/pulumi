...
export const plexAniBridgeService = new ContainerService("plexanibridge", {
  ...
  envs: {
    ...
    // PAB_PROFILES__1__SYNC_MODES: JSON.stringify(["periodic", "webhook"]),
    ...
    PAB_PROFILES__2__SYNC_MODES: JSON.stringify(["periodic", "webhook"]),
    ...
    PAB_PROFILES__3__SYNC_MODES: JSON.stringify(["periodic", "webhook"]),
    ...
    PAB_PROFILES__4__SYNC_MODES: JSON.stringify(["periodic", "webhook"]),
  },
  middlewares: ["auth"],
});
